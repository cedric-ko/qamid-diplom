...
* 33 сценария проверки заполнения и отправки веб-формы на странице "Оплата по карте", в том числе тест-кейсы, проверяющие:
